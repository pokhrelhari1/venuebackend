# Generated by Django 3.1.2 on 2021-03-26 17:01
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('paymentDate', models.DateTimeField(blank=True, default=datetime.datetime(2021, 3, 26, 22, 46, 10, 356370))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('feedbackDate', models.DateTimeField(blank=True, default=datetime.datetime(2021, 3, 26, 22, 46, 10, 357367))),
        ...
        migrations.AddField(
            model_name='catering',
            name='items',
            field=models.ManyToManyField(blank=True, related_name='catering', to='accounts.MenuItems'),
        ),
        migrations.AddField(
            model_name='booking',
            name='catering',
